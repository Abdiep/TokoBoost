            ...
            <main className="flex-grow container mx-auto px-4 md:px-6 py-8">
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <p>
                            Selamat datang di TokoBoost AI! Kami adalah platform revolusioner yang membantu para pelaku usaha, terutama UMKM, untuk membuat materi promosi yang menarik dan profesional dengan mudah menggunakan kekuatan kecerdasan buatan (AI).
                        </p>
                        <p>
